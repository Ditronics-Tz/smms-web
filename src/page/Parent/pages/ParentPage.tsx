                ...
                >
                    <thead>
                        <tr style={{ textAlign: 'center' }}>
                            ...
                            <th style={{ width: 50, padding: '10px 6px', }}>{t("parent.gender")}</th>
                            <th style={{ width: 130, padding: '10px 6px', }}>{t("parent.email")}</th>
                            <th style={{ width: 100, padding: '10px 6px', }}>{t("parent.mobile")}</th>
                                ...
                                <td>
                                    {/* <Dropdown>
                                        ...
                                        <Menu size="sm" sx={{ minWidth: 140 }}>
                                            <MenuItem>{t("parent.view")}</MenuItem>
                                            <Divider />
                                            <MenuItem color="danger">{t("parent.delete")}</MenuItem>
                                        </Menu>
                                    </Dropdown> */}
                                    <ButtonGroup variant="outlined" size="sm">
...
const ParentPage = ({
    ...
    const handleSubmit = (event) => {
        ...
        if (parentData.first_name) {
            ...
            // formData.append("school", parentData.school);
